...
public class DrugDataAPI {

    private static ArrayList<DrugDataModel> dataSet;


    public static ArrayList<DrugDataModel> getAllDrugs() {
        if(dataSet == null) {
            populateDrugData();
        }
    ...
    private static void populateDrugData() {
        dataSet = new ArrayList<>(1000);

        parseRawData(dataSet, RAW_DATA_1, true);
        parseRawData(dataSet, RAW_DATA_2, false);
        parseRawData(dataSet, RAW_DATA_3, false);
        parseRawData(dataSet, RAW_DATA_4, false);
    }
